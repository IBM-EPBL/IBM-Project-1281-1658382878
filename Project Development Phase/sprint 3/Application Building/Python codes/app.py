...
client = Cloudant.iam("023ba5f5-9b27-4df0-8897-2775e22f558d-bluemix", "EHGFHmRV9OnzKC4ajd-ItoxQC8bJDefpAbZ91wQTrvkO",
                      connect=True)
database = client.create_database("image_database")
